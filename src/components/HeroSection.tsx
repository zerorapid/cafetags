    ...
    <div className="w-full relative bg-[#1C1412] flex items-center justify-center overflow-hidden h-[250px]" style={{ textAlign: 'center' }}>
      <div className="absolute inset-0 z-0 w-full h-full">
        <OptimizedImage 
          ...
          imageClassName="w-full h-full object-cover object-center opacity-50"
        />
      </div>
      <div className="relative z-10 px-5 mx-auto max-w-[1440px] flex flex-col items-center justify-center">
        <h1 className="t-d1 !text-white leading-tight">
          <span className="block">Hyderabad</span>
          <span className="block"><em className="!text-[#F2E4D8]">Cafe</em> Corners ☕🥐</span>
        </h1>
