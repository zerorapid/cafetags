      ...
      <aside className="w-full md:w-64 bg-stone-950 text-stone-300 flex flex-col shadow-xl z-10 shrink-0">
        <div className="p-6 border-b border-stone-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-serif text-lg text-white font-bold tracking-wide">Owner Center</h2>
              <p className="text-[10px] text-amber-500 font-mono tracking-widest uppercase">Admin Workspace</p>
            </div>
          </div>
        </div>
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-4 py-3 rounded-lg transition-all text-sm font-semibold cursor-pointer ${
        ...
        {onLogout && (
          <div className="p-4 border-t border-stone-800">
            <button
              onClick={onLogout}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-stone-900 hover:bg-stone-800 text-stone-400 hover:text-white transition-all text-xs font-bold uppercase tracking-wider cursor-pointer"
            >
