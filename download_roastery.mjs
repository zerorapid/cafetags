...
const cafe = { 
  name: 'roastery', 
  url: 'https://www.district.in/dining/hyderabad/roastery-coffee-house-1-banjara-hills?srsltid=AfmBOoq3Dx0-qt30z8woeVWNYJ17iEuLjA9UWlfq5pbnoeu52FEJlHA3', 
...
(async () => {
  ...
  console.log('Done downloading and updating Roastery Coffee House!');
})();
