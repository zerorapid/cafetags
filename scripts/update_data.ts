...
for (let cafe of filteredCafes) {
    ...
    // It's not Blue Tokai, and not Niloufer
...
const fileContent = `import { Cafe } from './types';

export const INITIAL_CAFES: Cafe[] = ${JSON.stringify(filteredCafes, null, 2)};
`;

fs.writeFileSync('src/data.ts', fileContent, 'utf8');
