...
const endString = 'export const INITIAL_BLOG_ARTICLES';
...
// The end block starts with export const INITIAL_BLOG_ARTICLES
// We need to just put `export const INITIAL_CAFES: Cafe[] = ` then JSON.stringify(newCafes) + `;\n\n` + the rest.
