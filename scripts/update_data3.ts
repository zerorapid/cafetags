...
// Find the end of the array by searching for export const INITIAL_BLOG_ARTICLES
// Or simply export const getTagIcon = (tag: string) => {
const endIndex = content.indexOf('export const getTagIcon = (tag: string) => {');
